...
class Settings(BaseSettings):
    # 🤖 Motor de IA (UNIFICADO: qwen3:8b)
    MODEL_NAME: str = Field(default="qwen3:8b", description="Modelo de Ollama")
    ...
    # 🌐 API & Servidor
    API_HOST: str = Field(default="127.0.0.1", description="Host del servidor API")
...
# Configuración de logging centralizada (con mkdir seguro)
